...
public class UsersRepositoryImpl implements UsersRepository {
    ...
    public User findById(Long id) {
        ...
        try {
            String query = "SELECT * FROM " + Main.SCHEMA_NAME + "." + Main.TABLE_USER_NAME + " WHERE id = ";
    ...
    public List<User> findAll() {
        return jdbcTemplateObject.query("SELECT * FROM " + Main.SCHEMA_NAME + "." + Main.TABLE_USER_NAME, new UserMapper());
    }
    ...
    public Optional<User> findByName(String name) {
        ...
        try {
            String query = "SELECT * FROM " + Main.SCHEMA_NAME + "." + Main.TABLE_USER_NAME + " WHERE name = ?";
    ...
    public void save(User newUser) {
        String query = "INSERT INTO " + Main.SCHEMA_NAME + "." + Main.TABLE_USER_NAME + " (name, password) VALUES (?, ?)";
    ...
    public void update(User updUser) {
        ...
        String query = "UPDATE " + Main.SCHEMA_NAME + "." + Main.TABLE_USER_NAME + " SET email = ? WHERE id = ?";
    ...
    public void delete(Long id) {
        ...
        jdbcTemplateObject.update("DELETE FROM " + Main.SCHEMA_NAME + "." + Main.TABLE_USER_NAME + " WHERE id = ?", id);
    }
}
